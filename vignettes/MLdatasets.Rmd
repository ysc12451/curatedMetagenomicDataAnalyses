...
write_csv(metadata, "crc_res.csv")
```
...
unified_data3 <- cbind(metadata, unified_data3)
colnames(unified_data3)[1] = "observations"
write_csv(unified_data3, "crc_all.csv")
```
...
write.csv(unified_data2, "crc_separate_features.csv")
```
